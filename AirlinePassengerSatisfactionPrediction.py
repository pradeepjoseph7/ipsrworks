...
st.write("Airline Passenger Satisfaction Prediction Web App")
...
#filename = 'Final_model.pkl'
  loaded_model = load_model('Final_model_airline')
#loaded_model = pickle.load(open(filename, 'rb'))
  predictions_df = predict_model(estimator=loaded_model, data=testdata_df)
#predictions = predictions_df['Label'][0]
  st.write("Airline Passenger Satisfaction Prediction Results are: ")
